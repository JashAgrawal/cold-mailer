...
import BlogPostStructuredData from "../email-templates-that-get-responses/blog-post-structured-data";
              ...
              {blogPosts
                ...
                .map(post => (
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">{post.excerpt.substring(0, 100)}...</p>
                  </Link>
                ))
              }
            </div>
